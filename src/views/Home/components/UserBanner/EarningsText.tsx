...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and CHEESE pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and CHEESE pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from CHEESE pool', data)
  }
