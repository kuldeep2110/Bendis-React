    ...
    <IntroductionWrapper>
      <CardBody>
        <div>
          ...
          <List>
            <li>
              {t('While the sale is live, press the Buy button and input the amount of BNB')}
            </li>
          ...
          <List>
            <li>{t('4,000,000,000 CHEESE will be distributed to wallets who joined the presale.')}</li>
          </List>
          <Heading mb="10px">{t('After HardCap is reached')}:</Heading>
          <List>
            <li>{t('20,000,000,000 CHEESE will be distributed to wallets who joined the presale.')}</li>
          </List>
          <Heading mb="10px">{t('After Pre-Sale')}:</Heading>
          <List>
            <li>{t('Token will be vested until Feb 19th')}</li>
          </List>
        </div>
      </CardBody>
    </IntroductionWrapper>
