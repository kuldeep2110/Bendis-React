...
const GetLpModal: React.FC<Partial<Props>> = ({ currency, onDismiss }) => {
  ...
  return (
    <Modal title={t('CHEESE required')} onDismiss={onDismiss}>
      <ModalBody maxWidth="288px">
        <Image
          ...
          mb="24px"
        />
        <Text mb="16px">{t('You’ll need CHEESE tokens to participate in the IFO!')}</Text>
        <Text mb="24px">{t('Get CHEESE, or make sure your tokens aren’t staked somewhere else.')}</Text>
        <Button
          as={Link}
          external
