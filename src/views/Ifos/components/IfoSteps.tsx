    ...
    switch (step) {
        ...
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small mb="16px">
              {t('You’ll need an active CheeseSwap Profile to take part in an IFO!')}
            </Text>
            {renderAccountStatus()}
          </CardBody>
        )
      case 1:
        return (
          <CardBody>
            <Heading as="h4" color="secondary" mb="16px">
              {t('Get %symbol%', { symbol: 'CHEESE' })}
            </Heading>
            <Text color="textSubtle" small>
              {t('You’ll spend CHEESE to buy IFO sale tokens.')}
            </Text>
      ...
      case 2:
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small>
              {t('When the IFO sales are live, you can “commit” your CHEESE to buy the tokens being sold.')} <br />
      ...
      case 3:
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small>
              {t(
                'After the IFO sales finish, you can claim any IFO tokens that you bought, and any unspent CHEESE tokens will be returned to your wallet.',
              )}
            </Text>
          </CardBody>
        )
