  ...
  return [
    {
      ...
      bodyText: [t('You’ll need an active CheeseSwap Profile to buy Minting Tickets and mint a Pancake Squad NFT!')],
      buttons: (
        <>
    ...
    },
    {
      ...
      title: t('Hold CHEESE'),
      bodyText: [t('Each NFT costs CHEESE to mint. Remember you also need BNB to cover transaction fees too!')],
      buttons: (
        <>
          <Button
            as="a"
            href="https://cheeseswap.financial/swap?outputCurrency=0x9b79410C6657713AE2A459bAEFB3b3909154bADd"
            target="_blank"
            width="100%"
          >
            {t('Buy CHEESE')}
